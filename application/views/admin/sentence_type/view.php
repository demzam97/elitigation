...
<div class="msg <?php echo $this->session->flashdata('update') ?>"> <span><?php echo $this->session->flashdata('update_msg') ?></span></div>
  <?php endif; ?>
 <b><div class="panel-heading no-collapse">Sentence Type</div></b>
<table class="table table-bordered table-striped">
 ...
 foreach ($sentence_type as $row){
 $i++;
 echo "<tr>";
 echo    "<td width=5%>$i</td>";
 echo    "<td>$row->sentence_type</td>";
  echo    "<td>$row->sentence_type_description</td>";
 echo    "<td>";
 ?>
 <a href="<?php echo site_url('admin/sentence_type/edit')?>?id=<?php echo $row->id; ?>"i class="fa fa-pencil"> Edit</a>&nbsp;&nbsp;&nbsp;&nbsp;
 <a href="<?php echo site_url('admin/sentence_type/delete')?>?id=<?php echo $row->id; ?>" class="fa fa-trash-o" onclick="return confirm('Are you sure to Delete this ?');"> Delete</a>
 <?php
 echo "</td>";
 echo  "</tr>";
 }
...
<a href="<?php echo site_url('admin/sentence_type/add_new');?>" class="btn btn-primary pull-right">Add New</a>
