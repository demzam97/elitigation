...
<div class="dialog1">
    <div class="panel panel-default">
        <b><p class="panel-heading no-collapse">Add Disposal Type</p></b>
         <div class="panel-body">
           <form method="post" action="<?php echo site_url('admin/disposal_type/save'); ?>"  name="form1" onSubmit="return validate()">	
