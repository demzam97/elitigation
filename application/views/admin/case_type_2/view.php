...
<div class="msg <?php echo $this->session->flashdata('update') ?>"> <span><?php echo $this->session->flashdata('update_msg') ?></span></div>
  <?php endif; ?>
 <b><div class="panel-heading no-collapse">Case Type Level 2</div></b>
<table class="table table-bordered table-striped">
<tr>
 <th width="7%">No</th>
 <th>Case Type Level 1</th>
 <th>Name</th>
 <th>Description</th>
<th>Status</th>
 ...
 echo    "<td>".$this->admin->get_casel1($row->caseTypelevel1_id)."</td>";
 echo    "<td>$row->caseTypeleve2</td>";
 echo    "<td>$row->caseTypelevel2_description</td>";
 ?>
<td>
 <form action="<?php echo site_url('admin/case_type_2/activeinactive'); ?>" method="post">
 ...
 echo    "<td>";
 ?>
 <a href="<?php echo site_url('admin/case_type_2/edit')?>?id=<?php echo $row->id; ?>"i class="fa fa-pencil"> Edit</a>&nbsp;&nbsp;&nbsp;&nbsp;
 <a href="<?php echo site_url('admin/case_type_2/delete')?>?id=<?php echo $row->id; ?>" class="fa fa-trash-o" onclick="return confirm('Are you sure to Delete this ?');"> Delete</a>
 <?php
 echo "</td>";
...
<a href="<?php echo site_url('admin/case_type_2/add_new');?>" class="btn btn-primary pull-right">Add New</a>
