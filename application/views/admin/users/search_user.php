<div class="content">
<b><div class="panel-heading no-collapse">Users Search</div></b>
 <div class="panel-heading no-collapse" style="float:right;">
...
<table class="table table-bordered table-striped">
 ...
 <a href="<?php echo site_url('admin/user/reset_pass')?>?id=<?php echo $row->id; ?>" title="Reset Password">Reset Password</a>
 <?php
 echo "</td>";
 echo  "</tr>";
 }
...
<a href="<?php echo site_url('admin/user')?>" class="btn btn-primary pull-right">View All</a>
<script>
