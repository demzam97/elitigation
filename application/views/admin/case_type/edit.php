...
<div class="dialog1">
    <div class="panel panel-default">
        <b><p class="panel-heading no-collapse">Update Case Type</p></b>
         <div class="panel-body">
           <form method="post" action="<?php echo site_url('admin/case_type/update'); ?>"  name="form1" onSubmit="return validate()">	
                ...
                <div class="form-group">
                    <label><b>Case Type Description</b></label>
