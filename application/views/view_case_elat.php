                    ...
                    <?php
					 ...
					 //{
						...
						{?>
                            ...
                            <tr>
				<td><strong>Appeal Application Copy </strong> </td>
				<td><a href="<?php echo site_url('registration/viewUserAppealCopy/'.$appcopy.''); ?>" target="_blank"><?php echo $appcopy; ?></a></td>
...
else
{
  ...
  {?>
	<table class="table table-bordered table-striped">
        	<tr>
         		<td style="text-align:center;"><input type="radio" id="reg" name="regst" onclick="showReg()"/>&nbsp; Register &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" id="nreg" name="regst" onclick="closeReg()"/>&nbsp;Dismiss</td>
         	</tr>
        </table>
...
<div id="regBox">
<form id="appReg" method="post" action="<?php echo site_url('registration/appealReg_elat'); ?>" >  
<input type="hidden" name="reg_status" value="1" />
		<input type="hidden" name="old_case_id" value="<?php echo $case_id;?>" />
		<input type="hidden" name="elat" value="<?php echo $elat;?>" />
		<input type="hidden" name="hearingoption" value="<?php echo $hearingoption;?>" />
		<input type="hidden" name="appcopy" value="<?php echo $appcopy;?>" />
		<input type="hidden" name="elatuser" value="<?php echo $elatuser;?>" />
		<input type="hidden" name="applicantype" value="<?php echo $applicantype;?>" />
		<input type="hidden" name="appealdate" value="<?php echo $appealdate;?>" />
   <input type="hidden" name="old_case_id" value="<?php echo $case_id;?>" />
   <table class="blank_tbl">
   <tr>
       <td style="width:50%;">
   ...
   <tr>       
       ...
       <td>
          <div class="form-group">
            ...
            <input type="text" name="reg_date" id="start_dt2" class='datepicker' style="width:70%; height:34px; border:1px solid #ccc;border-radius:4px; padding:6px 12px;" />
          </div>
       </td>
       </tr>
       <tr>
       <td>
          <div class="form-group">          
            ...
            <input type="text" name="reg_number" style="width:70%;" value="<?php echo $this->session->userdata('court_abb'); ?>-<?php echo date('y'); ?>-" class='form-control' />
          </div>
          </td>
          <td>
          <div class="form-group">
		  ...
		  if($appl_id!='')
		  {
           ...
           <td>      
         <div class="form-group">
            <div style="float:left; margin-top:-8px;">Respondent: &nbsp;&nbsp;&nbsp;&nbsp;
            <!-- <a id="create-daily" class="btn btn-default">Add</a> -->
            </div>
          </div>
         <br />
        <div id="show">
        <?php $this->load->view('temp_litigantName_dunkhag'); ?> 
        </div>	
        </td>
        </tr>
        </table>      
...
<input type="hidden" name="reg_status" value="2" />
          <div class="form-group">
            ...
            <textarea name="notreg_reason" class='form-control' style="width:40%;"></textarea>
          </div>
          
          <div class="form-group">
            <label>Dismissal Order Number:</label>
            <input type="text" name="notreg_dis_no" class='form-control' style="width:40%;"/>
          </div>
          
          <div class="form-group">
            <label>Dismissal Order Date:</label><br />
            <input type="text" name="notreg_dis_date" id="start_dt3" class="datepicker" style="width:35%; height:34px; border:1px solid #ccc;border-radius:4px; padding:6px 12px;" />
          </div>
          
          <div class="form-group">
            <label>Signed By:</label><br />
            <select class="form-control" style="width:40%;" name="notreg_signedby[]">
            <option value="0" selected>Select One</option>
            <?php
			$judges=$this->public->get_hearing_judge();
			 foreach($judges as $user):?>
            <option value="<?php echo $user->id; ?>"><?php echo $user->judge_name; ?></option>
            <?php endforeach; ?>
            </select><a id="add_rtio_type3" class="btn btn-default" style="float:right; margin-top:-35px; ">Add More</a>
          </div>
           <div id="rtio_type3" style="text-align:center;">
...
<?php if($status==3 OR $status==1 OR $status==2){

	} else { ?>
<?php if($this->session->userdata('user_type')==2 && $c_approved!=1){
if($this->session->userdata('user_type')==2 && $a_approved!=1){

if($this->session->userdata('user_type')==2 && $reject!=1){
if($this->session->userdata('user_type')==2 && $approved!=1){ ?><a href="index.php/registration/approve_case/<?php echo $case_id; ?>"><input type="button" value="Approve" class="btn btn-primary" /></a>
&nbsp;&nbsp;&nbsp;&nbsp;
<input type="button" id="Reject" value="Reject" class="btn btn-danger" />&nbsp;&nbsp;&nbsp;&nbsp;
<!-- <a href="index.php/registration/view_rejected_case/<?php echo $case_id; ?>"><input type="button" id="update" value="Update" class="btn btn-warning" /></a> -->
<?php }}}} }
if($this->session->userdata('user_type')==2 && $approved==1 && $status==4 OR $status==5 && $a_approved!=1){?>
	<!-- <a href="index.php/registration/approve_case/<?php echo $case_id; ?>"><input type="button" value="Approve" class="btn btn-primary" /></a> -->
&nbsp;&nbsp;&nbsp;&nbsp;
<!-- <input type="button" id="Reject" value="Reject" class="btn btn-danger" />&nbsp;&nbsp;&nbsp;&nbsp; -->
<!-- <a href="index.php/registration/view_rejected_case/<?php echo $case_id; ?>"><input type="button" id="update" value="Update" class="btn btn-warning" /></a> -->
<?php
...
<p>&nbsp;</p>
<div id="reject_comment" style="display:none;">
<form method="post" action="index.php/registration/reject_case">
<label>Comment</label>
<input type="hidden" name="cas_id" value="<?php echo $case_id; ?>" />
<textarea name="rej_comment" class="form-control" rows="5"></textarea><br />
<input type="submit" name="submit" value="Submit" class="btn btn-primary" />&nbsp;&nbsp;&nbsp;
<input type="button" id="Rej_cancel" value="Cancel" class="btn btn-danger" />
</form>
</div>
