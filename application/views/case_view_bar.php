...
<?php
     ...
     { ?>
       <object width="800px" height="700px" data="<?php echo base_url('/images/barcouncilcertificate/'.$filename);?>"></object>
    <?php }
    else {
   ?>
   <iframe src="https://docs.google.com/gview?url=https://cms.judiciary.gov.bt/elat/images/barcouncilcertificate/<?php echo $filename;?>&embedded=true"
