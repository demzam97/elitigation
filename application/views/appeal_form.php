...
<table class="table table-bordered table-striped">
    ...
    <tr>
		<td>Appellent:</td>
        <td>
        <select name="litigant[]" class="form-control" style="width:40%" multiple="multiple">
    ...
    <tr>
     ...
     <tr>
        ...
        <td> <select name="sign_judge[]" class="form-control" multiple="multiple" style="width:40%">
    ...
    <tr>
     ...
     <tr>
		<td>Appeal Date:</td>
        <td>
        <input type="Date" name="appeal_date" required="required" data-beatpicker="true" placeholder="date" style="width:35%; height:34px; border:1px solid #ccc;border-radius:4px; padding:6px 12px;" />
        </div>
		</td>
	</tr>
...
<div id="div_rtio_types" style="display:none">
<table class="table table-bordered table-striped">
<tr>

      <option value="0" selected>Select One</option>
      <td?  <select name="litigant" class="form-control" style="width:40%">
...
$('#add_rtio_types').click(function(e) {
    $('#rtio_types').append($('#div_rtio_types').html());
    return false;
})</script>