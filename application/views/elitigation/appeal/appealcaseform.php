...
<form action="<?php echo site_url('elatappeal/add_appeal'); ?>" method="post" enctype="multipart/form-data" onsubmit="$('#loading').show();">
...
<div class="row"> 
  <div class="card-body mx-xl-4">                          
    ...
    <div class="form-group col-md-14">
        <label for="Name"><b>Appellate Court:</b></label>
...
<div class="card-body mx-xl-4">
  <br>
    <div class="form-group col-md-14">
    <label for="case_title"><b>Upload Appeal Petition Copy:<font color="red">*</font></b></label>
    ...
    <div class="form-group col-md-14">      
    <label for="case_title"><b>Mode of Hearing:<font color="red">*</font></b></label>
    <br>
