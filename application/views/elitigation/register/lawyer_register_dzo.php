...
<?php 
    ...
    <h5 class="card-title"><i class="fas fa-check-circle"></i>&nbsp;The CID number <?php echo $cidno;?> has already been registered as a user.</h5>
     <a href="<?php echo site_url('welcome/elat_registration_lawyer_dzo')?>" class="btn btn-primary">Return</a>
    </div>
    </div>
    </div>
    </div>
  ...
  <div class="col-md-8 col-xl-12" style="background-color:lightblue">
                <div class="row">
                    <div class="col-md-4">
                        <div class="md-form">
                            ...
                            <input type="text" class="form-control-plaintext" name="name" value="<?php echo trim($cDetail1[0]['firstDzoName']);?>">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="md-form">
                ...
                <div class="row">
                 ...
                 <div class="row">
                    <div class="col-md-4">
                        <div class="md-form">
                               <label for="occupation"><h3>ཆོག་ཐམ་ཨང་།<b style="color:red; font-size: 35px;">*</b></h3></label>
                ...
                <div class="row"> 
                    <div class="col-md-4">
                      <div class="md-form">
                       <label for="case_title"><h3>ལག་ཁྱེར།<b style="color:red; font-size: 35px;">*</b></h3></label>
                    ...
                    <!--<div class="col-md-4">
                        <div class="md-form">
                            <label for="cur_address"><h3>ཚོང་ལས/ཚོང་གི་ལས་སྡེའི་ཁ་བྱང་། <b style="color:red; font-size: 35px;">*</b></h3></label>
                            <textarea class="form-control" name="firmaddress" rows="3" required="required"></textarea>
                        </div>
                    </div>-->
<br><div class="card">
<div class="card-body" style="background-color: #edecec;">
<div class="row"><div class="col-md-12"><div class="md-form"><label for="cur_address"><h3>ཚོང་ལས/ཚོང་གི་ལས་སྡེའི་ཁ་བྱང་། <b style="color:red; font-size: 35px;">*</b></h3></label></div></div></div>
