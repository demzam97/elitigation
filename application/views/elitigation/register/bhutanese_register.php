                    ...
                    <div class="row">
                        <div class="col-md-8 col-xl-12">
                            ...
                            if (!empty($cDetail1[0]['cid']) == $cidno) {
                                ...
                                <?php $result = count($this->user->check_user_exists($cidno));
                                $usertype = $this->user->get_user_type($cidno);
                                ?>
                                <?php
                                if ($result != '') {
                                    if ($usertype == '12' || $usertype == '13' || $usertype == '15' || $usertype == '16') { ?>
                                                ...
                                                <div class="col-md-6 mx-auto">
                                                    <div class="row">
                                                        <div class="card">
                                                            ...
                                                            <div class="card-body">
                                                                <h5 class="card-title"><i class="fas fa-check-circle"></i>&nbsp;The CID number <?php echo $cidno; ?> has already been registered as a Petitioner.</h5>                                             <a href="<?php echo site_url('publicregistration/login') ?>" class="btn btn-primary">Go to Login Page</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-6 mx-auto">
                                                    <div class="row">
                                                        <div class="card">
                                                            <h5 class="card-header text-center" style="background-color: #ffc107;"><i class="fas fa-bell"></i>&nbsp;CID Verification</h5>
                                                            <div class="card-body">
                                                                <h5 class="card-title"><i class="fas fa-check-circle"></i>&nbsp;The CID number <?php echo $cidno; ?> has already been registered as a Respondent/Defendant. Would you like to Register as Applicant / Petitioner ?</h5>                                                                <a href="<?php echo site_url('publicregistration/store_bhutanese_register_other/' . $cidno) ?>" class="btn btn-primary">Yes</a>
                                                                <a href="<?php echo site_url('welcome/elat_registration_bht') ?>" class="btn btn-danger">No</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                    ...
                                    if ($usertype < '11') { ?>
                                        ...
                                        <form action="<?php echo site_url('publicregistration/store_bhutanese_register'); ?>" method="post" onsubmit="$('#loading').show();">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="md-form">
                                                        <label for="mobile"><b>Mobile Number:<font color="red">*</font></b></label>
                                            ...
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <div class="md-form">
                                                        <label for="mobile"><b>Alternative Mobile No.<font color="red">*</font></b>(Contact of a person through which you can be reached)</label>
                                                        <input type="number" class="form-control" name="alternate_mobile" required autofocus>
                                                    </div>
                                                </div>
                                                <div class="col-md-2 col-lg-2"><label for="cur_address"><b>Current Address<font color="red">*</font></b></label>
                                                    <div class="form-group">
                                                        <label class="control-label">House No./Building No.<font color="red">*</font></label>
                                                        <input type="text" class="form-control" name="cur_address_house" required autofocus />
                                                    </div>
                                                </div>
                                                <div class="col-md-2 col-lg-2"><label for="cur_address"><b> <br></b></label>
                                                    <div class="form-group">
                                                        <label class="control-label">Village/Place<font color="red">*</font></label>
                                                ...
                                                <div class="col-md-2 col-lg-2"><label for="cur_address"><b><br> </b></label>
                                                    <div class="form-group">
                                                        <label class="control-label">Street/Gewog/Thromde<font color="red">*</font></label>
                                                ...
                                                <div class="col-md-2 col-lg-2"><label for="cur_address"><b><br> </b></label>
                                                    <div class="form-group">
                                                        <label class="control-label">Dzongkhag<font color="red">*</font></label>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <div class="md-form">
                                                    ...
                                                    <input type="number" class="form-control" name="mobile" required="required" onkeydown="limit(this);">
                                                </div>
                                            </div>
