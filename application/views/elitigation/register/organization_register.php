...
<input type="hidden" class="form-control form-control-sm" id="user_type" name="user_type" value="15">
                ...
                <div class="row">
                        <div class="col-md-4">
                        <div class="md-form">
                             <label for="licenseno"><b>Organization Name<font color="red">*</font></b></label>
                ...
                <div class="row">                   
                    ...
                    <div class="col-md-4">
                        <div class="md-form">
                            <label for="phone"><b>Office Phone No.<font color="red">*</font></b></label>
                            <input type="number" class="form-control" name="phone" required="required">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="md-form">
                            <label for="fax"><b>Office Fax No.</b></label>
                ...
                <div class="row">
                    <div class="col-md-4">
                     ...
                     <div class="col-md-4">
                        <div class="md-form">
                            <label for="office_address"><b>Office Address<font color="red">*</font></b></label>
                            <textarea class="form-control" name="office_address" rows="3" required="required"></textarea>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="md-form">
                             <label for="contactperson_email"><b>Contact Person's CID<font color="red">*</font></b></label>
