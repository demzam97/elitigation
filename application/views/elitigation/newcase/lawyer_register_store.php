...
function getAccessToken($token_url, $client_id, $client_secret) 
{
 ...
 if(count($data1) != '') {
?>
<form action="<?php echo site_url('publicregistration/store_lawyer_register'); ?>" method="post" onsubmit="$('#loading').show();">
<?php error_reporting(E_ALL & ~E_NOTICE);?>
 ...
 <input type="hidden" name="miscid" value="<?php echo $miscid;?>" >
    ...
    <div class="form-group">
        <label for="party_type"><b>Select Litigant<font color="red">*</font></b></label> 
        <select class="form-control form-control-sm" name="litigant_id" id="party_type" required autofocus>
            <option value="">Select Litigant</option>
            <?php foreach($litigants as $lat) {?>
	          <option value="<?php echo $lat->litigant?>"><?php echo $this->public->get_LitigantName($lat->litigant); ?></option><?php } ?>
        </select>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        <label for="email"><b>Phone<font color="red">*</font></b></label>
        <input type="text" class="form-control form-control-sm" name="mphone" required="required">
    </div>
    <div class="form-group">
        <label for="party_type"><b>Qualification:<font color="red">*</font></b></label>
        <input type="text" class="form-control form-control-sm" name="qualification" required="required">
    </div>
    <div class="form-group">
        <label for="party_type"><b>Firm Name:<font color="red">*</font></b></label>
        <input type="text" class="form-control form-control-sm" name="fname" required="required">
    </div>
    <div class="form-group">
        <label for="party_type"><b>Firm Address:</b></label>
        <input type="text" class="form-control form-control-sm" name="fadd" >
    </div>
