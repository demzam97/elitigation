 ...
 <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Upload Chargesheet</h5>
      </div>
      <div class="modal-body">
<form action="<?php echo site_url('publicregistration/store_chargesheet'); ?>" method="post" enctype="multipart/form-data">
    ...
    <div class="input-group">   
     <input type="file" name="chargesheet" class="form-control" required="required" id="fileUpload" >
      ...
      <?php  $uid = $this->session->userdata('user_id');?>
        <a href="<?php echo site_url('publicregistration/newcase/'.$uid.''); ?>"><button type="button" class="btn btn-danger btn-sm" data-dismiss="modal">Cancel</button></a>
