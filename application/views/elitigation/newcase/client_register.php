...
<div class="card">
<div class="card-body">
<h5 class="card-title font-weight-bold text-center"><i class="far fa-address-card"></i>&nbsp;&nbsp;Client Registration </h5>
    <div class="row">
...
<?php 
  ...
  <?php
    ...
    { 
      ?>    
<form action="<?php echo site_url('publicregistration/store_client_register'); ?>" method="post" onsubmit="$('#loading').show();">
  ...
  <div class="col-md-8 col-xl-12" style="background-color:lightblue">
                ...
                <div class="col-md-4">
                        <div class="md-form">
                             ...
                             <input type="number" class="form-control" name="amobile" >
                        </div>
                    </div>         
                    <div class="col-md-4">
                        <div class="md-form">
