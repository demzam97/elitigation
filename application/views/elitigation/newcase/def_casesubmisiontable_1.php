...
<!-- Tab Start -->
<div>
<h4>Submissions / Resubmission</h4>
<!-- Nav tabs -->
...
<table class="table table-bordered table-sm table-striped">
  ...
  <?php $i=1; foreach($usercases as $row):?>
   <tr>
      ...
      <td><?php
      $casefiles = $this->elat->get_cases_public_case_files_def($row->id, $uid);
...
&nbsp;&nbsp;<a href="<?php echo site_url('publicregistration/casefiledownload/'.$row1->file_name.'');?>"><i class="fa fa-download" style="color:green;"></i></a>
        <br/>
       <?php $k++; endforeach;
      ?></td>
      <td>
...
<table class="table table-bordered table-sm table-striped">
  <thead class="thead-dark">
    <tr>
      ...
      <th scope="col">Reg.No</th>
      <th scope="col">Case Title</th>
      <th scope="col">Case Documents Uploaded by Plaintiff / Petitioner / Applicant</th>
      <th></th>
    </tr>
  </thead>
  <tbody>
  <?php $i=1; foreach($usercases as $row):?>
   <tr>
      ...
      <td><?php echo $row->case_title;?></td>
      <td><?php
      $casefiles = $this->elat->get_cases_public_case_files($row->id, $pid);
        $k = 1; foreach($casefiles as $row1):
        echo $k; echo ". "; echo $row1->file_name;?>
        <a href="<?php echo site_url('publicregistration/delete_case_files/'.$row1->id.'/'.$row1->file_name.'');?>" title="Delete" onclick="return confirm('Are you sure to Remove the File');">
        <i class="fa fa-trash" style="color:red;"></i></a>
...
<form action="<?php echo site_url('publicregistration/store_new_case_documents_def_1'); ?>" method="post" enctype="multipart/form-data">
