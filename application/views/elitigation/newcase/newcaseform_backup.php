...
<div class="row"> 
  ...
  <br>
    ...
    <div class="input-group">
     <input type="file" name="jurisdiction_copy" class="form-control" required="required" id="fileUpload" >
    </div>
   <b><i> Note: </i></b><br>
...
<div class="form-group col-md-14">
    ...
    <div class="form-group col-md-14">
    <label for="case_title"><b>Upload Relevant Documents:</b></label>
    <div class="input-group">
     <input type="file" name="cid_copy" class="form-control" id="fileUpload">
    </div>
    </div>
