...
<div class="col-sm-12">
<div class="card">
<form action="<?php echo site_url('Case_submission/update_case'); ?>" method="post" enctype="multipart/form-data">
<?php foreach($case as $crow):?>
<div class="row"> 
  <div class="card-body mx-xl-4">                          
    ...
    <div class="form-group col-md-14">
        ...
        <input type="text" class="form-control form-control" name="case_title" value="<?php echo $crow['case_title']; ?>">
    </div>
    <div class="form-group col-md-14">
        <label for="case_brief"><b>Case Brief:</b></label>
        <textarea class="form-control form-control" name="case_brief"  id="case_brief" rows="6">
        <?php echo $crow['case_breif']; ?></textarea>
    </div>
  </div>
  ...
  <div class="card-body mx-xl-4">                          
   ...
   (Defendents Details)
        ...
        <input type="text" class="form-control form-control" id="name" name="dname" value="<?php echo $crow['defendent_name']; ?>">
    </div>
    <div class="form-group col-md-14">
       <label for="CID"><b>CID:</b></label>
       <input type="text" class="form-control form-control" id="cid" name="cid" value="<?php echo $crow['cid']; ?>">
    </div>
     <div class="form-group col-md-14">
       <label for="defendentcontact"><b>Contact No.:</b></label>
       <input type="text" class="form-control form-control" name="defendentcontact" value="<?php echo $crow['contact_no']; ?>">
    </div>
    <div class="form-group col-md-14">
        <label for="address"><b>Address:</b></label>
        <textarea class="form-control form-control" name="address"  id="address" rows="2">
        <?php echo $crow['address']; ?></textarea>
    </div>
  </div>
