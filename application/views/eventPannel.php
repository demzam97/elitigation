...
<?php
			   ...
			   {?>
               <input type="button" value="Add Event" id="addEv" onclick="showBox();" class="btn btn-primary"/>
               <?php
			   }?>
 <h3 class="ctitle">Events On &nbsp;&nbsp;&nbsp;&nbsp;<span style="color:#F60; font-weight:bold; font-size:13px; font-family:Arial, Helvetica, sans-serif;"><?php echo $day." ".$this->calcase->getMonth($month)." ".$year?></span></h3>

<br />
<?php
$events=array();
$events=$this->calcase->getEventOn($year,$month,$day);
