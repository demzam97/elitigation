  ...
  <div class="row">
    ...
    <div class="col-sm-4" style="background-color:white;">
      <div class="card-header" style="background-color: white;">
        <h5 class="page-title">གསང་ཚིག་ གསརཔ་བཟོ་ནི།<br> </h5>
      </div>
      <div class="card-header" style="background-color: white;">
      ...
      <div class="card-body"> 
      <form action="<?php echo site_url();?>/welcome/updatepass_dzo" method="post">
        <input type="hidden" class="form-control form-control-sm" id="pwdchange_status" name="pwdchange_status" value="1">
          ...
          <div class="form-group">
            <button type="submit" value="update" class="btn btn-primary btn-flat" onclick="return confirm('Are you sure to submit');"><h3>གསང་ཚིག་སོར།</h3></button>
          </div>
      </form>
      </div></div></div>
    <div class="col-sm-4"></div>
