...
<div id="formBox">
 <span style="width:100%;">
  ...
  <hr />
  <form action="<?php echo site_url('registration/addJudicialForm1'); ?>" method="post">
...
<form method="post" action="index.php/registration/Update_caseActivity1" enctype="multipart/form-data"> 
     ...
     <div class="panel panel-default" style="width:100%; float:left; padding:10px; margin-bottom:10px;" > 
      ...
      <td> <strong>Form Used</strong> <input type="button" onclick="showForm()" class="css_btn_class" value="Add" style="float:right;" /></td>
       ...
       <?php 
          ...
          ?>
     <tr><td><?php echo $this->public->get_form_name($fld->form_used); ?><span style="float:right; "><a href="<?php echo site_url('registration/deleteJudicialForm1/'.$fld->id); ?>"  style="cursor:pointer;" onclick='return confirm("Are you sure?")' ><img src='<?php echo base_url(); ?>images/cross.png' style='width:10px; float:right; margin-top:5px;'></a></span> -  <?php echo $fld->Issued; ?></td></tr>
          <?php } ?>
