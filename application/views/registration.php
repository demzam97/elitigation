...
<div class="main-content">
 <div style=" border-radius:5px; padding:15px; height:auto; float:left; width:100%; margin-bottom:10px; border:1px solid #ddd;">
        ...
        <form name="frm1" method="post" action="index.php/registration/add_registration" enctype="multipart/form-data" onsubmit="return validate()">
  ...
  <td width="15%">
        ...
        <label>Miscellaneous Number<font color="red">*</font>:</label>
   </td>
   <td width="20%">
        <input type="text" name="misc_case" id="misc_case" required="required" class="form-control" style="width:80%;" value="<?php echo $this->session->userdata('court_abb'); ?>-<?php echo date('y'); ?>-" />
   ...
   <td width="15%">    
      ...
      <td width="20%">
        <input type="text" id="start_dt" name="app_date" class="datepicker" style=" width:75%; height:34px; border:1px solid #ccc;border-radius:4px; padding:6px 12px;" required="required"/>
     </td>
     </tr>
     <tr>
     <td>
     ...
     <td>
          <textarea  name="case_title" class="form-control"  required="required" style="width:80%; margin:5px !important;"></textarea>
        
      
        </td>
        <td>
            <label>Miscellaneous Hearing Date<font color="red">*</font>:</label>
        </td>
        <td>
             <input type="text" id="start_dt1" name="hearing_date" required="required" class='datepicker' style=" width:75%; height:34px; border:1px solid #ccc;border-radius:4px; padding:6px 12px;"/> 
...
<hr />
     ...
     <div style="float:right; width:58%; padding:10px;">
             Petitioner / Plaintiff : &nbsp;&nbsp;&nbsp;&nbsp;<a id="create-daily" class="btn btn-default">Add</a>
   ...
   <br />
		...
		<div class="form-group">
            <label>Registration Number<font color="red">*</font>:</label><br />
            <input type="text" name="reg_number" id="reg_number" required="required" style="width:80%;" value="<?php echo $this->session->userdata('court_abb'); ?>-<?php echo date('y'); ?>-" class='form-control' />
              <div id="showExistReg"></div>      
          </div> 
		
          <div class="form-group">
            <label>Registration Date<font color="red">*</font>:</label><br />
            <input type="text" name="reg_date" id="start_dt2" name="app_date" class="datepicker" required="required" style="width:75%; height:34px; border:1px solid #ccc;border-radius:4px; padding:6px 12px;" />
          </div>
          ...
          <br />
              <input type="submit" value="Submit" class="save_Form btn btn-primary" onclick="this.style.display='none';">
...
<div id="form_input" title="Insert/Edit Item">
      <table>
        ...
        <tr>
         ...
         <form action="<?php echo site_url('registration/insert_liti_id'); ?>" id="addLits" method="post">
