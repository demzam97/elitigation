...
<form method="post" action="index.php/registration/add_caseActivity" name="frm1" onsubmit="return validate()"> 
 ...
 <table class="table table-bordered table-striped">
    ...
    <tr>
		...
		<td colspan="2">
        <input type="text" name="act_date"  class="datepicker" placeholder="Date" style=" height:34px; border:1px solid #ccc;border-radius:4px; padding:6px 12px;" required />
        </td>
	</tr>
    </table>
</div>
...
<?php endforeach; ?>
 ...
 <td width='25%'>
      ...
      <td colspan="35%">
       <input type="text" name="formdate" class="datepicker"  place holder="Date" style="height:34px; border:1px solid #ccc;border-radius:4px; padding:6px 12px;" />
                </td>
 <td width='10%'>
