...
?>
	<form id="appReg" method="post" action="<?php echo site_url('registration/appealReg_elat'); ?>" >  
		...
		<div class="form-group col-md-6">
			<label>Misc Case No :</label>
			<input type="text" name="misc_case" class='form-control' value="<?php echo $this->session->userdata('court_abb'); ?>-<?php echo date('y'); ?>-" />
		...
		<div class="col-md-6 form-group">
			...
			<input type="text" name="reg_number" value="<?php echo $this->session->userdata('court_abb'); ?>-<?php echo date('y'); ?>-" class="form-control" />
		</div>
 		<div class="col-md-6 form-group">
			<label>Assigned to which bench:</label>
...
<input type="date" id="start_dt1" name="reg_date" class='datepicker' style=" width:75%; height:34px; border:1px solid #ccc;border-radius:4px; padding:6px 12px;"/> 
		</div>
		<div class="clearfix"></div>
		<div class="form-group col-md-6">
			<div style="float:left; margin-top:-8px;">Respondent/Defendant: &nbsp;&nbsp;&nbsp;&nbsp;
				<!--<a id="create-daily" class="btn btn-default">Add</a>-->
			</div>
		</div>
		<div id="show">
			<?php $this->load->view('temp_litigantName_elat_hc'); ?> 
		</div>	
		<div id="rtio_type3">
