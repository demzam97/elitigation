  ...
  <td width="15%">
   ...
   <td width="15%">    
     ...
     <td>
        ...
        <td>
             <input type="text" id="start_dt1" name="hearing_date" class='datepicker' style=" width:75%; height:34px; border:1px solid #ccc;border-radius:4px; padding:6px 12px;" required="required"/> 
