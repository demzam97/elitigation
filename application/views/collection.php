...
<div class="main-content">
 <form name="frm1" id="frm1" method="post" action="index.php/registration/insert_collection" > 
       ...
       <td>
       <input type="text" name="case_no" id="case_no" class="form-control" style="width:40%;">
       <div class="ErrMsg"></div>
       </td>
       </tr>
       <tr>
       ...
       <option value="<?php echo $litigant->id; ?>"><?php echo $litigant->litigant_name; ?></option>
        <?php endforeach; ?>
       </select>
       <div class="ErrMsg"></div>
       </td>
       ...
       <td>
       <input type="text" name="amount" id="amount" class="form-control" style="width:40%;">
       <div class="ErrMsg"></div>
       </td>
       </tr>
       ...
       <td>
       <input type="text" name="receipt_no" id="receipt_no" class="form-control" style="width:40%;">
       <div class="ErrMsg"></div>
       </td>
       </tr>
       ...
       <td>
       <input type="text" name="receipt_date" id="start_dt2" class="datepicker" style="width:35%; height:34px; border:1px solid #ccc;border-radius:4px; padding:6px 12px;" />
       <div class="ErrMsg"></div>
       </td>
       </tr>
       </table>
