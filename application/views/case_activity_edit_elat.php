...
<form method="post" action="index.php/registration/Update_caseActivity_elat" enctype="multipart/form-data"> 
 ...
 <table class="table table-bordered table-striped">
    ...
    <tr>
        ...
        <input type="time" id="appt" name="act_time" min="09:00" max="18:00" placeholder="Time" style=" height:34px; border:1px solid #ccc;border-radius:4px; padding:6px 12px;" value="<?php echo $activity_time; ?>" />
        </td>
	</tr>
    </table>
    </div>
