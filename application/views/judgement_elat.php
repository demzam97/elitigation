...
<form method="post" action="index.php/registration/add_judgement_elat" id="frm1" name="frm1"  enctype="multipart/form-data"> 
    ...
    <input type="text" name="judgement_no" id="judgement_no" required="required" style="width:80%;" class='form-control' value="<?php echo $this->session->userdata('court_abb'); ?>-<?php echo date('y'); ?>-" />
    <!--    <div id="showExistJudg"</div> -->
     ...
     <tr>
		...
		<td >
         <input type="date" name="judgement_date" id="start_dt" name="judgement_date" required="required" min="<?php $date = date("Y/m/d"); echo date('Y-m-d', strtotime($date. ' - 10 days'));?>" onkeydown="return false" style="width:75%; height:34px; border:1px solid #ccc;border-radius:4px; padding:6px 12px;" />
       ...
       <!-- <input type="text" placeholder="dd-mm-yyyy" name="judgement_date" id="judgement_date" data-beatpicker="true"  style="width:75%; height:34px; border:1px solid #ccc;border-radius:4px; padding:6px 12px;" /> -->
		...
		<td>
        <select class="form-control" style="width:80%;" name="disposal" id="disposal" required="required">
    ...
    <table class="table table-bordered table-striped" style="border:1px solid #F90;">
     ...
     <div id="sentence_one<?php echo $n; ?>" style="display:none;"> 
      ...
      <tr>
        	...
        	<td>
            <input type="date" class="start_dt"  name="start_date[]" min="<?php $date = date("Y/m/d"); echo date('Y-m-d', strtotime($date. ' - 10 days'));?>" onkeydown="return false" style="width:75%; height:34px; border:1px solid #ccc;border-radius:4px; padding:6px 12px;" />
            </td>
        </tr>
        <tr>
                <td width="15%"><strong>Release Date:</strong></td>
                <td>
                <input type="date" class="release_date" name="release_date[]" min="<?php $date = date("Y/m/d"); echo date('Y-m-d', strtotime($date. ' - 10 days'));?>" onkeydown="return false" style="width:75%; height:34px; border:1px solid #ccc;border-radius:4px; padding:6px 12px;" />
                </td>
        </tr>
...
<div id="displayBtns">
<input type="submit" class="btn btn-primary" value="Submit"  />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="button" class="btn btn-danger" value="Cancel" onclick="history.go(-1);" />
</div>
</form>
</div>
